...
// import { MdMenu, MdClose, MdDoubleArrow } from "react-icons/md";
  ...
  return (
    <ScreenLayout>
      <nav className="w-full flex justify-between items-center p-4 md:p-6 bg-white">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="absolute top-0 right-0 w-2/3 h-full transition-transform duration-300 bg-white shadow-lg lg:hidden">
            <div className="flex justify-end p-4">
              <button onClick={toggleMobileMenu}>
                <MdClose size={30} className="text-blue-800" />
              </button>
